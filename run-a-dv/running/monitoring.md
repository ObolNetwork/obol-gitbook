...
2.  Click on `+ Add contact point`. It will show the following page. Choose Discord in the `Integration` drop down.
    ...
    <figure><img src="../../.gitbook/assets/image (26).png" alt="Screenshot: Click on + Add contact point. It will show the following page. Choose Discord in the Integration drop down."><figcaption></figcaption></figure>
