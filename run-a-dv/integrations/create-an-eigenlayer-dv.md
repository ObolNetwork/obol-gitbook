...
* If creating more than one validator, the ability to use the [obol-sdk](../../advanced-and-troubleshooting/advanced/create-a-dv-using-the-sdk.md) is required.
...
* Use the "Create a cluster with a group" [flow](../start/create-a-dv-with-a-group.md) on the [DV Launchpad](../../learn/intro/launchpad.md).
...
* Follow the [Create a cluster using the SDK](../../advanced-and-troubleshooting/advanced/create-a-dv-using-the-sdk.md) guide.
