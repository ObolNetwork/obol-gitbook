---
sidebar_position: 5
description: Add credentials to help the Obol Team monitor the health of your cluster
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/qEcekJHEGL3v8mnLzK2b/run-a-dv/start/obol-monitoring
---
