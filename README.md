...
|  |  |
| --- | --- |
| **📘 Learn About DVT**  <br> Start here to understand DVT, how Charon (our middleware) works, and why distributed validators are fundamental to Ethereums future. <br> [Learn About DVT](learn/charon/intro.md) | **🧩 Integrate DVT**  <br> Deploy DVs on mainnet or testnet and follow the quickstart path for operators and allocators. <br> [Integrate DVT](run-a-dv/start/quickstart_overview.md) |
