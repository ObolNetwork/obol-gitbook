...
<img src="/img/CharonProtocolLayers.png" alt="Internal Validator Stack" width="75%"/> <br/>
...
Obol hosts a publicly accessible relay at https://0.relay.obol.tech and will work with other organizations in the community to host alternatives  Anyone can host their own relay server for their DV cluster.
