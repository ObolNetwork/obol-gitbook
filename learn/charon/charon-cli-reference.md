...
The following is a reference for Charon version [`v1.3.0`](https://github.com/ObolNetwork/charon/releases/tag/v1.3.0). Find the latest release on [our Github](https://github.com/ObolNetwork/charon/releases).
