...
The following is a reference for Charon version [`v1.10.2`](https://github.com/ObolNetwork/charon/releases/tag/v1.10.2). Find the latest release on [our Github](https://github.com/ObolNetwork/charon/releases).
