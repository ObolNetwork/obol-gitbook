...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/qEcekJHEGL3v8mnLzK2b/learn/readme/frequently-asked-questions
---
...
### General[​](frequently-asked-questions.md#general) <a href="#general" id="general"></a>

#### Does Obol have a token?[​](frequently-asked-questions.md#does-obol-have-a-token) <a href="#does-obol-have-a-token" id="does-obol-have-a-token"></a>
...
#### Where can I learn more about Distributed Validators?[​](frequently-asked-questions.md#where-can-i-learn-more-about-distributed-validators) <a href="#where-can-i-learn-more-about-distributed-validators" id="where-can-i-learn-more-about-distributed-validators"></a>
...
#### Where does the name Charon come from?[​](frequently-asked-questions.md#where-does-the-name-charon-come-from) <a href="#where-does-the-name-charon-come-from" id="where-does-the-name-charon-come-from"></a>
...
#### What are the hardware requirements for running a Charon node?[​](frequently-asked-questions.md#what-are-the-hardware-requirements-for-running-a-charon-node) <a href="#what-are-the-hardware-requirements-for-running-a-charon-node" id="what-are-the-hardware-requirements-for-running-a-charon-node"></a>
...
#### What is the difference between a node, a validator and a cluster?[​](frequently-asked-questions.md#what-is-the-difference-between-a-node-a-validator-and-a-cluster) <a href="#what-is-the-difference-between-a-node-a-validator-and-a-cluster" id="what-is-the-difference-between-a-node-a-validator-and-a-cluster"></a>
...
#### Can I migrate an existing Charon node to a new machine?[​](frequently-asked-questions.md#can-i-migrate-an-existing-charon-node-to-a-new-machine) <a href="#can-i-migrate-an-existing-charon-node-to-a-new-machine" id="can-i-migrate-an-existing-charon-node-to-a-new-machine"></a>
...
### Distributed Key Generation[​](frequently-asked-questions.md#distributed-key-generation) <a href="#distributed-key-generation" id="distributed-key-generation"></a>

#### What are the min and max numbers of operators for a Distributed Validator?[​](frequently-asked-questions.md#what-are-the-min-and-max-numbers-of-operators-for-a-distributed-validator) <a href="#what-are-the-min-and-max-numbers-of-operators-for-a-distributed-validator" id="what-are-the-min-and-max-numbers-of-operators-for-a-distributed-validator"></a>
...
### Obol Splits[​](frequently-asked-questions.md#obol-splits) <a href="#obol-splits" id="obol-splits"></a>

#### What are Obol Splits?[​](frequently-asked-questions.md#what-are-obol-splits) <a href="#what-are-obol-splits" id="what-are-obol-splits"></a>
...
#### Are Obol Splits non-custodial?[​](frequently-asked-questions.md#are-obol-splits-non-custodial) <a href="#are-obol-splits-non-custodial" id="are-obol-splits-non-custodial"></a>

Yes. Unless you were to decide to [deploy an editable splitter contract](frequently-asked-questions.md#can-i-change-the-percentages-in-a-split), Obol Splits are immutable, non-upgradeable, non-custodial, and oracle-free.

#### Can I change the percentages in a split?[​](frequently-asked-questions.md#can-i-change-the-percentages-in-a-split) <a href="#can-i-change-the-percentages-in-a-split" id="can-i-change-the-percentages-in-a-split"></a>
...
#### How do Obol Splits work?[​](frequently-asked-questions.md#how-do-obol-splits-work) <a href="#how-do-obol-splits-work" id="how-do-obol-splits-work"></a>

You can read more about how Obol Splits work [here](obol-splits.md).

#### Are Obol Splits open source?[​](frequently-asked-questions.md#are-obol-splits-open-source) <a href="#are-obol-splits-open-source" id="are-obol-splits-open-source"></a>

Yes, Obol Splits are licensed under GPLv3 and the source code is available [here](https://github.com/ObolNetwork/obol-splits).

#### Are Obol Splits audited?[​](frequently-asked-questions.md#are-obol-splits-audited) <a href="#are-obol-splits-audited" id="are-obol-splits-audited"></a>
...
#### Are the Obol Splits contracts verified on Etherscan?[​](frequently-asked-questions.md#are-the-obol-splits-contracts-verified-on-etherscan) <a href="#are-the-obol-splits-contracts-verified-on-etherscan" id="are-the-obol-splits-contracts-verified-on-etherscan"></a>
...
#### Does my cold wallet have to call the Obol Splits contracts?[​](frequently-asked-questions.md#does-my-cold-wallet-have-to-call-the-obol-splits-contracts) <a href="#does-my-cold-wallet-have-to-call-the-obol-splits-contracts" id="does-my-cold-wallet-have-to-call-the-obol-splits-contracts"></a>
...
#### Are there any edge cases I should be aware of when using Obol Splits?[​](frequently-asked-questions.md#are-there-any-edge-cases-i-should-be-aware-of-when-using-obol-splits) <a href="#are-there-any-edge-cases-i-should-be-aware-of-when-using-obol-splits" id="are-there-any-edge-cases-i-should-be-aware-of-when-using-obol-splits"></a>
...
### Debugging Errors in Logs[​](frequently-asked-questions.md#debugging-errors-in-logs) <a href="#debugging-errors-in-logs" id="debugging-errors-in-logs"></a>
