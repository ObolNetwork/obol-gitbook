---
description: >-
  Enable the TLS protocol to secure HTTPS requests made by the Validator Client
  to Charon.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/qEcekJHEGL3v8mnLzK2b/advanced-and-troubleshooting/advanced/enable-tls-protocol
---
